...
public class Triangle {
  ...
  public Triangle(Point point1, Point point2, Point point3, int colIndex) {
    this.point1 = point1;
    this.point2 = point2;
    this.point3 = point3;
  ...
  public boolean isOver(int x, int y) { // returns true when the position x, y
    ...
    int px = x - point1.getX();
    int py = y - point1.getY();
    int t2x = point2.getX() - point1.getX();
    int t2y = point2.getY() - point1.getY();
    int t3x = point3.getX() - point1.getX();
    int t3y = point3.getY() - point1.getY();
